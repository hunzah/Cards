...
export const SliderDemo = () => {
    ...
    const changeSliderValue = (values:number[]) => {
        values[0] === minSliderValue ? setMaxSliderValue(values[1])
    ...
    return (
        <div className={s.SliderContainer}>
            ...
            <Slider.Root onValueChange={changeSliderValue} className={s.SliderRoot} defaultValue={[minSliderValue, maxSliderValue]} minStepsBetweenThumbs ={1} max={100} step={1}>
